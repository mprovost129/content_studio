...
urlpatterns = [
    ...
    path(
        "paths/<slug:slug>/",
        views.PublicSeriesDetailView.as_view(),
        name="series-detail",
    ),
    ...
    path(
        "resources/<slug:slug>/unlock-pdf/",
        views.PublicResourcePDFGateView.as_view(),
        name="resource-pdf-gate",
    ),
    path(
        "resources/<slug:resource_slug>/cta/<int:pk>/",
        views.PublicResourceCTAClickView.as_view(),
        name="resource-cta-click",
    ),
    path(
        "resources/<slug:slug>/download.pdf",
        views.PublicResourcePDFDownloadView.as_view(),
        name="resource-pdf",
    ),
    path(
        "resources/<slug:slug>/",
        views.PublicResourceDetailView.as_view(),
        name="resource-detail",
    ),
    path(
        "quiz/<int:question_pk>/submit/", views.submit_quiz_answer, name="quiz-submit"
    ),
    path(
        "challenge/<int:challenge_pk>/submit/",
        views.submit_challenge_attempt,
        name="challenge-submit",
    ),
    path(
        "challenge-attempts/<int:pk>/",
        views.ChallengeAttemptDetailView.as_view(),
        name="challenge-attempt-detail",
    ),
