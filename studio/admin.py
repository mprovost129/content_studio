...
class RecommendationTuningChangeLogAdmin(admin.ModelAdmin):
    list_display = ("created_at", "action", "tuning", "changed_by", "preset_name", "experiment_label", "experiment_status", "experiment_outcome", "changed_field_count")
    list_filter = ("action", "experiment_status", "experiment_outcome", "preset_key", "created_at")
    search_fields = ("tuning__name", "changed_by__email", "preset_name", "preset_key", "reason", "request_path", "experiment_label", "experiment_notes")
    ...
    fieldsets = (
        ...
        ("Experiment", {"fields": ("experiment_label", "experiment_status", "experiment_outcome", "experiment_notes", "outcome_recorded_at", "outcome_recorded_by")}),
...
class RecommendationTuningExperimentSnapshotAdmin(admin.ModelAdmin):
    list_display = ("generated_at", "change_log", "window_days", "before_start", "after_end", "generated_by")
    list_filter = ("window_days", "generated_at", "change_log__experiment_status", "change_log__experiment_outcome")
    search_fields = ("change_log__experiment_label", "change_log__preset_name", "notes", "generated_by__email")
...
class ExperimentDecisionTuningAdmin(admin.ModelAdmin):
    list_display = (
        "name", "is_active", "keep_score_threshold", "rollback_score_threshold",
        "low_confidence_abs_score", "max_metric_change_magnitude", "updated_at"
    )
    list_filter = ("is_active",)
    search_fields = ("name", "notes")
    readonly_fields = ("created_at", "updated_at")
    fieldsets = (
        ("Thresholds", {"fields": ("name", "is_active", "keep_score_threshold", "keep_primary_positive_min", "keep_high_confidence_score", "rollback_score_threshold", "rollback_primary_negative_min", "rollback_high_confidence_score", "low_confidence_abs_score", "max_metric_change_magnitude")}),
        ("Positive-signal weights", {"fields": ("social_new_followers_weight", "social_engagements_weight", "social_reach_weight", "social_clicks_weight", "resources_pdf_downloads_weight", "resources_pdf_unlocks_weight", "resources_subscribers_weight", "newsletter_clicks_weight", "newsletter_open_rate_weight", "ctas_cta_clicks_weight", "conversions_total_conversions_weight", "conversions_lesson_views_weight", "conversions_quiz_attempts_weight", "conversions_challenge_attempts_weight", "conversions_lesson_completions_weight")}),
        ("Negative-signal weights", {"fields": ("newsletter_unsubscribes_penalty_weight", "newsletter_bounces_penalty_weight")}),
        ("Notes", {"fields": ("notes", "created_at", "updated_at")}),
    )
