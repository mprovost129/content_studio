...
# OPENAI_API_KEY and is never persisted by the application.
OPENAI_MODEL = os.environ.get('OPENAI_MODEL', 'gpt-5.6-terra')
OPENAI_REASONING_EFFORT = os.environ.get('OPENAI_REASONING_EFFORT', 'low')
OPENAI_REQUEST_TIMEOUT = float(os.environ.get('OPENAI_REQUEST_TIMEOUT', 60))

# Optional public website origin used for canonical lesson URLs in website exports.
CONTENT_WEBSITE_BASE_URL = os.environ.get('CONTENT_WEBSITE_BASE_URL', '').rstrip('/')
